...
@Component({
  selector: 'app-delete_MincienciaCategory',
  templateUrl: './delete_MincienciaCategory.component.html',
  styleUrls: ['./delete_MincienciaCategory.component.css']
})
export class Delete_MincienciaCategoryComponent implements OnInit {
    ...
    this.mincienciaCategoryService.deleteItem(formValue.id).subscribe(
      () => {
              var date = new Date('2020-01-01 00:00:03');
                ...
                detail: 'Categoria de Minciencias Eliminada con exito'});
                }
