...
@Component({
  selector: 'app-edit_Kind_of_Investigation',
  templateUrl: './edit_Kind_of_Investigation.component.html',
  styleUrls: ['./edit_Kind_of_Investigation.component.css']
})
export class Edit_Kind_of_InvestigationComponent implements OnInit {
  ...
  public onSubmit() {
   ...
   this.bandera=true
    ...
    this.kind_of_InvestigationService.updateItem(formValue.id,formValue).subscribe(
      () => {
              var date = new Date('2020-01-01 00:00:03');
                ...
                detail: 'Tipo de Investigaciones Actualizado con exito'});
                }
