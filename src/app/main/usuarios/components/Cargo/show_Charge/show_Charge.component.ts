...
@Component({
  selector: 'app-show_Charge',
  templateUrl: './show_Charge.component.html',
  styleUrls: ['./show_Charge.component.css']
})
export class Show_ChargeComponent implements OnInit {
  ...
  private rows2:ChargeI[] = []

  exportColumns: any[]=[];
  selectedProducts: ChargeI[]=[];
  constructor(
        ...
        content: [
          {
            columns: [
              ...
              {
                width: '*',
                text: `Cargos de Administrativos`, alignment: 'center', fontSize: 15 ,bold: true,margin: [ 0, 40, 0, 0 ]
              }
            ],
    ...
    exportExcel() {
      ...
      import("xlsx").then(xlsx => {
          ...
          this.saveAsExcelFile(excelBuffer, "charges");
      });
    }
