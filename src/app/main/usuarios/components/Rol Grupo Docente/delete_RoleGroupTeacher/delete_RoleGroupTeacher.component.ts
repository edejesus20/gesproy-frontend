...
@Component({
  selector: 'app-delete_RoleGroupTeacher',
  templateUrl: './delete_RoleGroupTeacher.component.html',
  styleUrls: ['./delete_RoleGroupTeacher.component.css']
})
export class Delete_RoleGroupTeacherComponent implements OnInit {
  ...
  public onSubmit() {
    ...
    this.roleGroupTeacherService.deleteItem(formValue.id).subscribe(
      () => {
              var date = new Date('2020-01-01 00:00:03');
                ...
                detail: 'Rol Docente Para Grupo Eliminado con exito'});
                }
