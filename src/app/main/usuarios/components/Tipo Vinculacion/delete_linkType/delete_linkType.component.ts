...
@Component({
  selector: 'app-delete_linkType',
  templateUrl: './delete_linkType.component.html',
  styleUrls: ['./delete_linkType.component.css']
})
export class Delete_linkTypeComponent implements OnInit {
  ...
  public onSubmit() {
    ...
    if(formValue.id){
    this.linkTypeService.deleteItem(formValue.id).subscribe(
      () => {
              var date = new Date('2020-01-01 00:00:03');
                ...
                detail: 'Tipo de Vinculación Eliminada con exito'});
                }
