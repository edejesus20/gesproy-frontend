...
@Component({
  selector: 'app-delete_Knowledge_area',
  templateUrl: './delete_Knowledge_area.component.html',
  styleUrls: ['./delete_Knowledge_area.component.css']
})
export class Delete_Knowledge_areaComponent implements OnInit {
 ...
 public onSubmit(f:NgForm) {
  ...
  if(formValue.name != ''){
    if(formValue.id)
  this.knowledge_areaService.deleteItem(formValue.id).subscribe(
    () => {
            var date = new Date('2020-01-01 00:00:03');
              ...
              detail: 'Area de Conocimiento Eliminada con exito'});
              }
